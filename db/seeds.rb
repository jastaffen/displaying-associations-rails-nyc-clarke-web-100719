...
nycrestaurants = Category.create!(name: "Restaurants in NYC")
nycrestaurants.posts.create!(title: "10 best bagels in NYC")
nycrestaurants.posts.create!(title: "Best Pizza in NYC")
nycrestaurants.posts.create!(title: "Which pizza place you'd love based on your personality")
